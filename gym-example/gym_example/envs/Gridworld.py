...
class Gridworld(gym.Env):
    ...
    def __init__(self, size=4, mode='static'):
        ...
        self.observation_space = gym.spaces.Box(low = 0, high = 100, shape=(size, size))
        self.size = size
        self.mode = mode
        self.reset()
    ...
    def reset(self):
        ...
        self.count = 0
        self.state = self.board.render_np().reshape(1, 64) + np.random.rand(1, 64) / 100.0
